...
<body class="bg agileinfo">
	...
	<ul>
		...
		<li class="faza"><a href="<?php echo base_url('index.php/welcome/index')?>">Log out</a></li>
   ...
   <h1 class="agile_head text-center">Travel Time</h1>
     <div class="container w3">
     	<form action="#" method="post" class="agile_form">
     		<font color="black" size="5px">Selamat Datang , <?php echo $this->session->set_userdata('nama');?></font>
     	</form>
		<form action="#" method="post" class="agile_form">
